...
export const SNS_TOPIC_DESCRIPTIONS = {
  [SNS_TOPICS.TRADE_SIGNALS]: 'Trading signals and alerts from external sources',
  [SNS_TOPICS.MARKET_LOG_COLLECTION]: 'Market log collection from external sources',
  [SNS_TOPICS.PROFITABLE_MARKET_LOGS_ANALYSIS]: 'Profitable market logs analysis for learning and ML training',
} as const;
